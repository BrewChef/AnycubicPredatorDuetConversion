...
M552 P192.168.0.180 S1				; Enable network and acquire dynamic address via DHCP
M586 P0 S1							; Enable HTTP
M586 P1 S1							; Enable FTP (enable or disable for your needs)
M586 P2 S1							; Enable Telnet (enable or disable for your needs)

;### Drives ###
M569 P0 S0  						; Drive 0 (X) goes forwards, stealthChop mode, switch from stealthChop to to spreadCycle mode only at high speeds
M569 P1 S0 							; Drive 1 (Y) same as Drive 0 
M569 P2 S0 							; Drive 2 (Z) same as Drive 0 
M569 P3 S0 							; Drive 3 (Extruder) goes backwards, spreadCycle mode
M350 X16 Y16 Z16 E16 I1				; Configure microstepping with interpolation
M92 X80.00 Y80.00 Z80.00 E415.00	; Set steps per mm  (Extruder Bondtech clone!)
...
;M566 X900.00 Y900.00 Z900.00 E1500.00		; Set maximum instantaneous speed changes (mm/min)
M566 X600.00 Y600.00 Z600.00 E1200.00		; Set maximum instantaneous speed changes (mm/min) changed 20180411 1330

M906 X1000.00 Y1000.00 Z1000.00 E800.00 I30 	; Set motor currents (mA) and motor idle factor in per cent
M84 S30                                     	; Set idle timeout

;### Delta configuration ###
M665 R227 L440 B185 H425		; Set delta radius, diagonal rod length, printable radius and homed height 
...
;### Z-Probe ###
M558 P8 R0.4 F1200 				; Set Z probe type to switch and the dive height + speeds
G31 P100 X0 Y0 Z-0.1			; Set Z probe trigger value, offset and trigger height - must be adjusted for your machine
...
;### Tools ###
M200 D1.75						; turn volumetric control off
